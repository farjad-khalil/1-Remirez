        ...
        <div className="hidden md:grid md:grid-cols-3 gap-8 mb-8 md:px-52">
          <div>
            <div className="flex items-center mb-4">
              <Image src="/assets/main_logo.svg" alt="M. Ramirez Logo" width={300} height={300} className="mr-2" />
            </div>
        ...
        <div className="md:hidden px-6">
          ...
          <div className="text-center mb-6">
            <div className="flex justify-center mb-4">
              <Image src="/assets/main_logo.svg" alt="M. Ramirez Logo" width={300} height={300} />
            </div>
