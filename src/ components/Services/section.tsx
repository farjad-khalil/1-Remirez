...
export default function Section({index, title, h1, h2, h3, desc_1, desc_2, desc_3, img ,icon}: any) {
  ...
  return (
    <section className='p-14 bg-offWhite '>
      ...
      <div className="flex flex-col md:flex-row items-center justify-center ">
        ...
        <div className={`w-full md:w-1/2 px-6 md:px-16 order-1 ${index%2==0 ? "md:order-2" : "md:order-1"} `}>
          {/* Title */}
          ...
          {/* Features List */}
          <div className="mt-6 space-y-6 px-4 md:px-10 text-lg">
            ...
            <div className="flex items-start gap-3">
              <div className="text-3xl text-neonGreen font-bold">✔</div>
              <div>
                <h3 className="text-lg font-bold">{h2}</h3>
            ...
            <div className="flex items-start gap-3">
              <div className="text-3xl text-neonGreen font-bold">✔</div>
              <div>
                <h3 className="text-lg font-bold">{h3}</h3>
        ...
        {/* Call-to-Action Button (Appears last on mobile) */}
      </div>
      {/* <div className="flex justify-center md:ml-80 p-10">
